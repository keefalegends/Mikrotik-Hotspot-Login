...
Tampilan halaman login dan status koneksi hotspot MikroTik dengan desain modern dark theme bergaya Winbox/RouterOS. Dibuat dengan HTML, CSS, dan JavaScript murni — tanpa framework. 
